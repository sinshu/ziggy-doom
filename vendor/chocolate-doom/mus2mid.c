...
// doomgeneric provides PACKEDATTR rather than Chocolate Doom's PACKED_STRUCT.
#ifndef PACKED_STRUCT
#define PACKED_STRUCT(content) struct PACKEDATTR content
#endif
...
boolean mus2mid(MEMFILE *musinput, MEMFILE *midioutput)
{
    ...
    // Each song conversion must be independent, including after a failed input.
    queuedtime = 0;
